...
public class testClass {
    ...
    public void Test() throws IOException, InterruptedException {
        ...
        List<WebElement> valueInPriceFields = driver.findElements(By.cssSelector("span > span.new_sum"));
        ...
        String startLimit = "4000";
        inputWindForPriceAlloFilter.sendKeys(startLimit);

        inputWindForPriceAlloFilter.submit();
        Thread.sleep(8000);

        valueInPriceFields = new ArrayList<WebElement>();

        for (WebElement element: valueInPriceFields) {
            //TODO get end Limit from the page
//            if(startLimit > element > endLimit) {
//                Assertions.fail("Element on the page out of limit");
//            }
        }
